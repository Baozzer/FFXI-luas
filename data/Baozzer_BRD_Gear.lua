...
function init_gear_sets()
    ...
    sets.precast.FC = {
--testing dispelga. disabled main swap
		main="Mafic Cudgel",
		sub="Genmei Shield",
		-- range and ammo slot. Messes up bard songs
		--ammo='Sapience Orb',  -- 2%
		head=Vanya_head, -- 10%
	...
	sets.precast.FC.BardSong = set_combine(sets.precast.FC, {
		-- no range or ammo. Messes up songs
        --range=Linos_QC, -- 0% | 4%
...
-----------------------------------------------------------------------------------------------------------------
	...
	sets.midcast['Buff']['Ballad']	 					= set_combine(sets.midcast['Buff'], {})
	...
	sets.midcast['Buff']['Extra Length']['Honor March']					= set_combine(sets.midcast['Buff']['Extra Length'], {range={name='Marsyas',priority = 16}})
